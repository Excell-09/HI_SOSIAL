...
const Navbar = ({ id, en }) => {
  ...
  return (
    <div className="shadow-xl fixed w-full top-0 z-[999999] font-plus-jakarta-sans bg-white">
      <div className="font-plus-jakarta-sans flex justify-between items-center AppContainer bg-white py-3">
        ...
        <div
          className={`absolute shadow-xl -z-10 py-3 md:py-5 px-5 left-0 top-20 w-full transition duration-700 lg:static lg:translate-y-0 bg-white lg:z-0 lg:py-0 lg:px-0 lg:shadow-none lg:ml-auto lg:max-w-max lg:flex lg:items-center ${
          ...
          <button
            type="button"
            className="w-32 btn-blue lg:rounded-full text-sm mt-3 lg:text-base lg:mt-auto lg:ml-10 lg:w-auto">
            Contact Us
          </button>
        </div>
      </div>
