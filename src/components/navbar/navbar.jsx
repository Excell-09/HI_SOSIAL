...
const Navbar = ({ id, en }) => {
  ...
  return (
    <div className="py-3 shadow-xl fixed w-full top-0 bg-white z-[999999] font-plus-jakarta-sans">
      <div className="flex justify-between lg:justify-between items-center font-plus-jakarta-sans max-w-[1110px] m-auto">
        <img src={logo} className="cursor-pointer ms-4 " />
        <div
          className="me-10 text-2xl border-2 border-black p-1 rounded hover:bg-gray-300 lg:opacity-0 cursor-pointer"
          onClick={() => handleOpen()}>
        ...
        <div
          ...
          <button
            type="button"
            className="w-32 btn-blue rounded-full text-sm mt-1 lg:text-base lg:mt-auto lg:mx-10 lg:w-auto ">
            Contact Us
          </button>
        </div>
      </div>
