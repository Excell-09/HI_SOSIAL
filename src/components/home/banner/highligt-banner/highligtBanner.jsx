const HighligtBanner = ({ t, className }) => {
  return (
    ...
    <section
      ...
      <p className="font-clash-display text-xl font-medium md:text-2xl lg:text-5xl md:col-span-2  ">
        {t("Home.banner.highlight-banner")}
      </p>

      <div className="text-center flex flex-col md:flex-row md:space-x-4 md:col-span-3 lg:space-x-7 lg:justify-between">
        {/* flex gap-5 items-center md:flex-col */}
        <div>
        ...
        {/* flex gap-5 items-center md:flex-col md:gap-5 lg:gap-10 */}
        <div>
          <p className="text-2xl font-semibold md:text-4xl lg:text-[50px]">
            05+
          </p>
