    ...
    <article className="p-5 sm:p-2 bg-white rounded-2xl md:space-x-5 md:justify-center md:flex md:items-center lg:justify-between 2xl:justify-around shadow-lg w-full">
      <div className="flex ">
        ...
        <div className="flex-1 px-5">
          <div className="flex gap-5 justify-between sm:justify-start mb-3 sm:mb-5">
            <div className="sm:hidden">
              <h6 className="text-lg">Chen Lee Alexander</h6>
              <p className="text-gray-500 text-sm">{t("Home.testi.job")}</p>
            </div>
            <FaQuoteLeft className="text-gray-400 text-xl sm:text-3xl lg:text-2xl rotate-180" />
          </div>
