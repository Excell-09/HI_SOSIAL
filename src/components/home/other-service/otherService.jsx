...
const OtherService = ({ t }) => {
  return (
    <section className="lg:pb-8 AppContainer">
      ...
      <div className="flex flex-col items-center space-y-5 md:space-y-0 md:space-x-5 lg:space-x-5 md:flex-row md:justify-between">
